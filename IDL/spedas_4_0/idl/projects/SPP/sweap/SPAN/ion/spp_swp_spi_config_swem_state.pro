...
; $URL: svn+ssh://thmsvn@ambrosia.ssl.berkeley.edu/repos/spdsoft/tags/spedas_4_0/projects/SPP/sweap/SPAN/ion/spp_swp_spi_config_swem_state.pro $
;-


PRO spp_swp_spi_config_swem_state, mem, info
