...
;  $URL: svn+ssh://thmsvn@ambrosia.ssl.berkeley.edu/repos/spdsoft/tags/spedas_4_0/projects/mms/sitl/sitl_data_fetch/mms_sitl_get_dfg.pro $





pro mms_sitl_get_dfg, sc_id=sc_id, no_update = no_update, reload = reload, level = level
...
;      endelse
    ...
    dfg_vecname = sc_id(j) + '_dfg_srvy_dmpa'
    split_vec, dfg_vecname
        
    join_vec, [dfg_vecname + '_0', dfg_vecname + '_1', dfg_vecname + '_2'], dfg_vecname
