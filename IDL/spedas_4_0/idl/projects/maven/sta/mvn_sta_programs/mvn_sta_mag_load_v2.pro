...
; $URL: svn+ssh://thmsvn@ambrosia.ssl.berkeley.edu/repos/spdsoft/tags/spedas_4_0/projects/maven/sta/mvn_sta_programs/mvn_sta_mag_load_v2.pro $
;
;-
pro mvn_sta_mag_load_v2, frame=frame, verbose=verbose,  tplot=tplot
  ...
  trange=timerange()
  mvn_mag_load, format='L2_1SEC',trange=trange
  get_data, 'mvn_B_1sec', data=data
  time=data.x
  magf=data.y
