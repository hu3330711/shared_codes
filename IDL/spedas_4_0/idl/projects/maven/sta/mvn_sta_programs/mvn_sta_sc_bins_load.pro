...
;   $URL: svn+ssh://thmsvn@ambrosia.ssl.berkeley.edu/repos/spdsoft/tags/spedas_4_0/projects/maven/sta/mvn_sta_programs/mvn_sta_sc_bins_load.pro $
;-
...
PRO mvn_sta_sc_bins_load, perc_block = perc_block,$
