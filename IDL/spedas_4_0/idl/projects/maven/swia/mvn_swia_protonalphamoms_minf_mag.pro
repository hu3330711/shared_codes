...
; $LastChangedDate: 2015-06-18 11:53:03 -0700 (Thu, 18 Jun 2015) $
; $LastChangedRevision: 17910 $
; $URL: svn+ssh://thmsvn@ambrosia.ssl.berkeley.edu/repos/spdsoft/tags/spedas_4_0/projects/maven/swia/mvn_swia_protonalphamoms_minf_mag.pro $
;
;-

pro mvn_swia_protonalphamom_minf_mag, dat = dat, n1, t1, v1, n2, t2, v2, plot = plot, archive = archive
...
pro mvn_swia_protonalphamoms_minf_mag, archive = archive, trange = trange
...
for i = 0,nt-1 do begin
	...
	mvn_swia_protonalphamom_minf_mag,dat = dat, n1,t1,v1, n2, t2, v2
	dens0[i] = n1
	temp0[i,*] = t1[0:2]
	vel0[i,*] = v1
	dens1[i] = n2
