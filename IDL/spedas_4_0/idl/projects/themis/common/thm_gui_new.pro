...
;$URL: svn+ssh://thmsvn@ambrosia.ssl.berkeley.edu/repos/spdsoft/tags/spedas_4_0/projects/themis/common/thm_gui_new.pro $
;-----------------------------------------------------------------------------------
PRO thm_gui_new,reset=reset,template_filename=template_filename


  message, /info, 'THM_GUI_NEW is now a wrapper for SPD_GUI'
