...
;$URL: svn+ssh://thmsvn@ambrosia.ssl.berkeley.edu/repos/spdsoft/tags/spedas_4_1/general/science/spd_units_string.pro $
;-
...
if keyword_set(simple) then begin
  ...
  case strlowcase(units) of
    ...
    'df'     : ustr = ['f (','s!U3!N/cm!U3!Nkm!U3!N',')']
