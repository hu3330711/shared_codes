...
; $URL: svn+ssh://thmsvn@ambrosia.ssl.berkeley.edu/repos/spdsoft/tags/spedas_4_1/general/missions/rbsp/efw/l1_to_l2/rbsp_efw_make_l2_spinfit.pro $
;
;-
...
;------------ Set up paths. END. ----------------------------
  ...
  tinterpol_mxn,rbx+'efw_vsvy',times,/overwrite
...
;-------------------------------------------------------
  ...
  ;density
  tinterpol_mxn,rbx+'density'+bp,times,/overwrite
  ...
  ;Esvy spinfit.
  tinterpol_mxn,rbx+'mag_mgse',times,newname=rbx+'mag_mgse'
  ...
  varsave_general = ['diagBratio',$
    ...
    'vsvy_vavg_combo',$
    'VxB_mgse','vel_coro_mgse',$
    'density',$
    'orbit_num','vel_gse','pos_gse','angle_Ey_Ez_Bo','mlt','mlat','lshell',$
    'spinaxis_gse',$
