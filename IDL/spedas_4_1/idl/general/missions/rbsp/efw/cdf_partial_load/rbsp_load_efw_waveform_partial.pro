...
; $URL: svn+ssh://thmsvn@ambrosia.ssl.berkeley.edu/repos/spdsoft/tags/spedas_4_1/general/missions/rbsp/efw/cdf_partial_load/rbsp_load_efw_waveform_partial.pro $
;-

pro rbsp_load_efw_waveform_partial,probe=probe, datatype=datatype, trange=trange, $
