...
;   $URL: svn+ssh://thmsvn@ambrosia.ssl.berkeley.edu/repos/spdsoft/tags/spedas_4_1/general/missions/rbsp/efw/examples/rbsp_efw_waveform_crib.pro $
;-
...
old_pcharsize=!p.charsize & !p.charsize=0.7
