...
; $URL: svn+ssh://thmsvn@ambrosia.ssl.berkeley.edu/repos/spdsoft/tags/spedas_4_1/general/missions/rbsp/efw/rbsp_load_efw_waveform_l2.pro $
;-

pro rbsp_load_efw_waveform_l2,probe=probe, datatype=datatype, trange=trange, $
