...
; $URL: svn+ssh://thmsvn@ambrosia.ssl.berkeley.edu/repos/spdsoft/tags/spedas_4_1/general/missions/rbsp/efw/rbsp_load_efw_fbk_l2.pro $
;-
...
pro rbsp_load_efw_fbk_l2,probe=probe, trange=trange, $
  ...
  rbsp_efw_init
  dprint,verbose=verbose,dlevel=4,'$Id: rbsp_load_efw_fbk_l2.pro 26349 2018-12-17 22:55:59Z aaronbreneman $'
  ...
  for s=0,n_elements(p_var)-1 do begin
     ...
     if is_string(tns) then begin
        ...
        options, /def, tns, code_id = '$Id: rbsp_load_efw_fbk_l2.pro 26349 2018-12-17 22:55:59Z aaronbreneman $'
