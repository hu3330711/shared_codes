...
; $URL: svn+ssh://thmsvn@ambrosia.ssl.berkeley.edu/repos/spdsoft/tags/spedas_4_1/projects/maven/quicklook/mvn_l0_db2file.pro $
;-
...
;  Else fpath = ppp.local_data_dir+'maven/data/sci/pfp/l0/'
  Else fpath = ppp.local_data_dir+'maven/data/sci/pfp/l0_all/'+yyyy+'/'+mmmm+'/'
