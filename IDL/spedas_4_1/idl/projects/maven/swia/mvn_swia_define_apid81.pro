...
; $URL: svn+ssh://thmsvn@ambrosia.ssl.berkeley.edu/repos/spdsoft/tags/spedas_4_1/projects/maven/swia/mvn_swia_define_apid81.pro $
;
;-

pro mvn_swia_define_apid81, decoder = decoder, data = data
