...
; $URL: svn+ssh://thmsvn@ambrosia.ssl.berkeley.edu/repos/spdsoft/tags/spedas_4_1/projects/maven/swea/mvn_swe_crosscal.pro $
;
...
function mvn_swe_crosscal, time, on=on, off=off, refresh=refresh, extrap=extrap, silent=silent
  ...
  if ((size(tc,/type) eq 0) or keyword_set(refresh)) then begin
    ...
    ac[*,5] = [1.9086D,  4.6361d-3, -1.0890d-5,  0.0D     ]  ; MCPHV = 2875 V
    eflg = 0
  endif
