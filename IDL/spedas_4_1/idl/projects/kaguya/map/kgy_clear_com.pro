...
; $URL: svn+ssh://thmsvn@ambrosia.ssl.berkeley.edu/repos/spdsoft/tags/spedas_4_1/projects/kaguya/map/kgy_clear_com.pro $
;-
...
@kgy_pace_com
  if keyword_set(onlydata) then begin
     ...
     undefine, ima_info_str,ima_fov_str,ima_header_arr,ima_type40_arr,ima_type41_arr,ima_type42_arr,ima_type43_arr
