...
; $URL: svn+ssh://thmsvn@ambrosia.ssl.berkeley.edu/repos/spdsoft/tags/spedas_4_1/projects/kaguya/map/pace/kgy_iea_get3d.pro $
;-
...
start_time = $
   time_double( string(iea_header_arr[i].yyyymmdd,format='(i8.8)') $
                +string(iea_header_arr[i].hhmmss,format='(i6.6)'), $
                tformat='YYYYMMDDhhmmss' )
