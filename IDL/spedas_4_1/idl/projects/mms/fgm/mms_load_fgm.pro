...
;$URL: svn+ssh://thmsvn@ambrosia.ssl.berkeley.edu/repos/spdsoft/tags/spedas_4_1/projects/mms/fgm/mms_load_fgm.pro $
;-
...
pro mms_load_fgm, trange = trange, probes = probes, datatype = datatype, $
    ...
    if keyword_set(available) or keyword_set(download_only) then return
