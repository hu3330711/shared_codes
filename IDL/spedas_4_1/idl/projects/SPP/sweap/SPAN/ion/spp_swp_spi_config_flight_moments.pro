...
; $URL: svn+ssh://thmsvn@ambrosia.ssl.berkeley.edu/repos/spdsoft/tags/spedas_4_1/projects/SPP/sweap/SPAN/ion/spp_swp_spi_config_flight_moments.pro $
;-


PRO spp_swp_spi_config_flight_moments, mem, info
