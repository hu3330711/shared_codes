...
;$URL: svn+ssh://thmsvn@ambrosia.ssl.berkeley.edu/repos/spdsoft/tags/spedas_1_00/spedas/gui/api_examples/load_data_tab/cl_ui_load_data_load_pro.pro $
;
;--------------------------------------------------------------------------------

pro cl_ui_load_data_load_pro,$
                         loadStruc,$
                         loadedData,$
                         statusBar,$
                         historyWin,$
  ...
  Case instrument of
     'aspoc':  begin
       cl_load_aspoc, probes=probes, trange=timeRange
     end
     'dwp': cl_load_dwp, probes=probes, trange=timeRange
     'cis':   cl_load_fgm, probes=probes, trange=timeRange
     'edi':   cl_load_edi, probes=probes, trange=timeRange
     'efw':   cl_load_efw, probes=probes, trange=timeRange
     'fgm':   cl_load_fgm, probes=probes, trange=timeRange
     'peace':   cl_load_peace, probes=probes, trange=timeRange
     'rapid':   cl_load_rapid, probes=probes, trange=timeRange
     'staff':   cl_load_staff, probes=probes, trange=timeRange
     'wbd':   cl_load_wbd, probes=probes, trange=timeRange
     'whisper':   cl_load_whi, probes=probes, trange=timeRange
     else:    cl_load_data, probes=probes, instrument=instrument, trange=timeRange
  endcase
