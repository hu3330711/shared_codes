...
; $URL: svn+ssh://thmsvn@ambrosia.ssl.berkeley.edu/repos/spdsoft/tags/spedas_4_1/external/spdfcdas/spd_cdawlib/spd_cdawlib_str_element.pro $
...
;      message,/info,'Testing...  Adding '+base_name+' to array of structures'
      s0 = struct[0]
;      v0 = value[0]   ;needs work: should be all but last dimension  (corrected below)
