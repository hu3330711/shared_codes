...
; $URL: svn+ssh://thmsvn@ambrosia.ssl.berkeley.edu/repos/spdsoft/tags/spedas_4_1/external/IDL_GEOPACK/t89/t89_test.pro $
;-
...
pro orbital_vf_t89, name
  ...
  proj_pos = project_t89([vp1, vp2], d.y)
  
  proj_mag = project_t89([vp1, vp2], td.y)
