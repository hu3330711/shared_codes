...
c          jf(3)=.false.      ! f=no ion composition 
          ...
          jf(6)=.false.      ! t=DS95+DY85   f=RBV10+TTS03
...
c          jf(31)=.false.         ! t=B0ABT f=Gulyaeva
     ...
     &            'condition {t}'
              ...
              read(5,*) jf(16)
              print *,'E peak storm model: t=on, f=off {f}'
              read(5,*) jf(35)
...
c
      ...
      if(PIKTAB.eq.3) then
        ...
        print *,'      equatorward auroral boundary [46]'
        ...
        if(pad1(1).eq.0) then
            ...
            pad1(3)=45     ! fof2_storm/foF2_quiet
             jf(26)=.true.
            pad1(4)=82     ! auroral boundary
             jf(33)=.true.            
            pad1(4)=46     ! foE_storm/foE_quiet
             jf(35)=.true.            
c            pad1(5)=23     ! solar zenith angle
