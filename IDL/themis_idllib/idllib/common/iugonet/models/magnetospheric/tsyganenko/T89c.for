...
c    See GEOPACK.TXT for an example of the field line tracing.
c
      dimension parmod(10)
...
C   LAST UPDATE:  MAY 9, 2006; A SAVE STATEMENT WAS ADDED IN THE S/R T89C,
C     TO AVOID RUNTIME PROBLEMS ON SOME FORTRAN COMPILERS
C--------------------------------------------------------------------------
C
C
