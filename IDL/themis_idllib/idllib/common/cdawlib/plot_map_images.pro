...
;$Header: /home/cdaweb/dev/control/RCS/plot_map_images.pro,v 1.133 2005/11/16 22:16:54 kovalick Exp kovalick $
;$Locker: kovalick $
;$Revision: 8 $
;
;--------------------------------------------------------------
...
;	    if keyword_set(DEBUG) then print, 'Calling 6th auroral_image'
		...
		CenterLonLat=[0.,-90] ;show whole earth w/ both poles
               ...
               auroral_image, idat(*,*,j), glon(*,*,j), glat(*,*,j), $
                  method="PL",/continents, /grid, centerLonLat=CENTERLONLAT, $
...
;                 of plots
      ...
      if COLORBAR then begin
         ...
         !y.window=[0.1,0.9]
         offset = 0.01
;TJK changed to allow log scaling to be set
