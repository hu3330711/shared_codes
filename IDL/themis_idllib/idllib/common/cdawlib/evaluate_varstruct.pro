...
;$Header: /home/cdaweb/dev/control/RCS/evaluate_varstruct.pro,v 1.51 2006/10/27 17:00:22 kovalick Exp kovalick $
;$Locker: kovalick $
;$Revision: 225 $
...
;;TJK		   if (dn(0) ne ' ') then pstruct.npanels = n_elements(dn)
		   ...
		   print, 'DEBUG - Display_type = ',a.DISPLAY_TYPE
		   print, 'DEBUG - setting npanels based on examine_spectrogram_dt to ',e.npanels
		 endif
