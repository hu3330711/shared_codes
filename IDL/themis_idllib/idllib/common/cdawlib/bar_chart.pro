...
;$Header: /home/cdaweb/dev/control/RCS/bar_chart.pro,v 1.11 2005/09/29 18:52:09 kovalick Exp kovalick $
;$Locker: kovalick $
;$Revision: 8 $
;-------------------------------------------------------------------------
; FUNCTION bar_chart, bar_names, bars, times, COLORS, BIGPLOT=BIGPLOT,
; FIVEYEAR=FIVEYEAR, COLORNEW=COLORNEW
;   bar_names : strarr(n)
;   bars      : lonarr(n,m)
;   times     : double(m)
...
plot,[0,1],[1,0],/nodata,xrange=[secs(0),secs(ntimes-1)],xmargin=[20,4],ymargin=[8,4],$
