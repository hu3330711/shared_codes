...
;$Header: /home/rumba/cdaweb/dev/control/RCS/inventory.pro,v 1.21 2005/02/28 21:51:33 kovalick Exp kovalick $
;$Locker: kovalick $
;$Revision: 8 $
;---------------------------------------------------------------------------
...
if keyword_set(GIF) then begin
  ...
  s = bar_chart(bar_names,bars,times,TITLE=mytitle,GIF=myGIF,xsize=800,BIGPLOT=bigplot,FIVEYEAR=fiveyear,COLORNEW=colornew)
endif else s = bar_chart(bar_names,bars,times,TITLE=mytitle,xsize=800,BIGPLOT=bigplot,FIVEYEAR=fiveyear,COLORNEW=colornew)
