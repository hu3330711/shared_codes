...
; 
; Copyright ・ｽ 2001 The Johns Hopkins University/Applied Physics Laboratory.
; All rights reserved.
; 
...
pro convert_geo_coord, lat_in,lon_in,height_in,lat_out,lon_out, $
  ...
  error=-2
  if ((height_in lt 0) or (height_in gt 7200000)) then return
  error=-8;
