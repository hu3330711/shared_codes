...
; $LastChangedDate: 2009-01-15 12:35:18 -0800 (Thu, 15 Jan 2009) $
; $LastChangedRevision: 4489 $
...
pro thm_load_asi_cdf_to_tplot_all, files=files, all=all, verbose=verbose, $
                               get_support_data=get_support_data, $
                               time=time, trange=trange, _extra=_extra

    cdf2tplot,/all,file=files,verbose=verbose
end



pro thm_load_asi_all,site = site, datatype = datatype, trange = trange, $
...
; Use the cursor to determine what asi's to load.
  ...
  thm_load_xxx,sname=site, datatype=datatype, trange=trange, $
               ...
               cdf_to_tplot = 'thm_load_asi_cdf_to_tplot_all', $ ;*****
               progobj = progobj, $
               _extra = _extra
