...
pro thm_scpot_density,probe=probe,datatype_esa=datatype_esa,datatype_efi=datatype_efi,noload=noload,merge=merge,noplot=noplot,scpot_esa=scpot_esa
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;load coefficients
fname=file_search('/projectnb/burbsp/big/SATELLITE/themis/software/idllib/themis/efi/th'+probe+'_scpot_density_coefficients.sav')
...
tplot,['th'+probe+'_pxxm_density','th'+probe+'_'+datatype_esa+'_density_comparison','th'+probe+'_'+datatype_esa+'_en_eflux_pot'],var_label=['th'+probe+'_R']
...
store_data,'th'+probe+'_'+datatype_efi_init+'_density_comparison',data={x:Vdata.x,y:[[Nedata.y],[Ne_scpot],[Ne_Sheeley_PSph],[Ne_Sheeley_PSsh]]},dlim={colors:[0,2,6,6],labels:['Ne_'+datatype_esa,'Ne_scpot','Ne_Sheeley_PSph','Ne_Sheeley_PSsh'],ysubtitle:'[cm-3]',labflag:-1,constant:0,ylog:1,linestyle:[0,0,0,2]}
