...
source.local_data_dir = '/big/SATELLITE/cdaweb.gsfc.nasa.gov/pub/istp/omni/'
source.remote_data_dir = 'http://aurora.atmos.ucla.edu/satellite/data/cdaweb.gsfc.nasa.gov/pub/istp/omni/'
source.use_wget=1
source.nowait=0
...
store_data,'BZ_GSM',data={x:Bgsm.x,y:Bgsm.y(*,2)},dlim={constant:0}
