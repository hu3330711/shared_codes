; $Id: hcolorbar.pro,v 1.10 1999/01/22 20:12:17 mgs Stab $
;-------------------------------------------------------------
;+
; NAME:
;        HCOLORBAR
...
;        bmy, 24 Jun 1997: VERSION 2.00
;        bmy, 30 Sep 1997: VERSION 2.01
;        bmy, 20 Nov 1997: VERSION 2.02
;
;-
...
;==============================================================================
   X0 = min(CX, max=X1)
   Y0 = min(CY, max=Y1)
   plots, [X0, X1, X1, X0, X0], [Y0, Y0, Y1, Y1, Y0], /norm, thick=2
   
;==============================================================================
;  Position the labels above the colorbar and return
;==============================================================================
   xyouts, XLAB, YLAB, LABELS, align=0.5, charsize=0.8, charthick=2, /norm 
