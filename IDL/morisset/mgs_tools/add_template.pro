; $Id: add_template.pro,v 1.12 1999/05/25 15:10:34 mgs Exp $
;-------------------------------------------------------------
;+
; NAME:
;       ADD_TEMPLATE
...
;     printf,lun,';'
      ...
      printf,lun,';        mgs, ',day,' ',month,' ',year,': VERSION 1.00'
      printf,lun,';'
      printf,lun,';-', format='(a)'


      printf,lun,'; Copyright (C) '+year+', Martin Schultz, Harvard University'
      printf,lun,   $
