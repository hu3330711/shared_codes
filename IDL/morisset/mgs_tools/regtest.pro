...
pro regtest,data,header,spec,npp=npp,rad=rad,ts=ts

  ; perform multiple linear regression with data passed from EXPLORE
  ; defaults set for CH3I surface water analysis


  ;  readdata,'test.dat',data,names,delim=' '

    if (n_elements(spec) eq 0) then $
        spec = [ 'CH3I' ]
