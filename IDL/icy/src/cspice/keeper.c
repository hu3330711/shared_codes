...
/*     call to ZZLDKER doesn't succeed. */
    ...
    ++loaded;
    cursrc = loaded;
    s_copy(files + ((i__1 = loaded - 1) < c__5300 && 0 <= i__1 ? i__1 : s_rnge(
	    "files", i__1, "keeper_", (ftnlen)1069)) * 255, file, (ftnlen)255,
	     file_len);
    s_copy(types + (((i__1 = loaded - 1) < c__5300 && 0 <= i__1 ? i__1 : s_rnge(
	    "types", i__1, "keeper_", (ftnlen)1070)) << 3), thstyp, (ftnlen)8,
	     (ftnlen)8);
    handls[(i__1 = loaded - 1) < c__5300 && 0 <= i__1 ? i__1 : s_rnge("handls", 
	    i__1, "keeper_", (ftnlen)1071)] = myhand;
    srces[(i__1 = loaded - 1) < c__5300 && 0 <= i__1 ? i__1 : s_rnge("srces", 
...
/*        files. */
	...
	++loaded;
	s_copy(files + ((i__1 = loaded - 1) < c__5300 && 0 <= i__1 ? i__1 : 
		s_rnge("files", i__1, "keeper_", (ftnlen)1354)) * 255, fil2ld,
		 (ftnlen)255, (ftnlen)255);
	s_copy(types + (((i__1 = loaded - 1) < c__5300 && 0 <= i__1 ? i__1 : 
		s_rnge("types", i__1, "keeper_", (ftnlen)1355)) << 3), thstyp,
		 (ftnlen)8, (ftnlen)8);
	handls[(i__1 = loaded - 1) < c__5300 && 0 <= i__1 ? i__1 : s_rnge("hand"
...
/*           variables right now. */
	    ...
	    *found = TRUE_;
	    s_copy(file, files + ((i__1 = *which - 1) < c__5300 && 0 <= i__1 ? 
		    i__1 : s_rnge("files", i__1, "keeper_", (ftnlen)1866)) * 
		    255, file_len, (ftnlen)255);
	    s_copy(filtyp, types + (((i__1 = *which - 1) < c__5300 && 0 <= i__1 ?
		     i__1 : s_rnge("types", i__1, "keeper_", (ftnlen)1867)) <<
		     3), filtyp_len, (ftnlen)8);
	    *handle = handls[(i__1 = *which - 1) < c__5300 && 0 <= i__1 ? i__1 : 
		    s_rnge("handls", i__1, "keeper_", (ftnlen)1868)];
	    if (srces[(i__1 = *which - 1) < c__5300 && 0 <= i__1 ? i__1 : s_rnge(
		    "srces", i__1, "keeper_", (ftnlen)1870)] != 0) {
		s_copy(source, files + ((i__2 = srces[(i__1 = *which - 1) < 
			c__5300 && 0 <= i__1 ? i__1 : s_rnge("srces", i__1, 
			"keeper_", (ftnlen)1871)] - 1) < c__5300 && 0 <= i__2 ? 
...
/*           requested information and return. */
	    ...
	    if (hits == *which) {
		*found = TRUE_;
		s_copy(file, files + ((i__2 = i__ - 1) < c__5300 && 0 <= i__2 ? 
			i__2 : s_rnge("files", i__2, "keeper_", (ftnlen)1916))
			 * 255, file_len, (ftnlen)255);
		s_copy(filtyp, types + (((i__2 = i__ - 1) < c__5300 && 0 <= i__2 
			? i__2 : s_rnge("types", i__2, "keeper_", (ftnlen)
			1917)) << 3), filtyp_len, (ftnlen)8);
		*handle = handls[(i__2 = i__ - 1) < c__5300 && 0 <= i__2 ? i__2 :
			 s_rnge("handls", i__2, "keeper_", (ftnlen)1918)];
		if (srces[(i__2 = i__ - 1) < c__5300 && 0 <= i__2 ? i__2 : 
			s_rnge("srces", i__2, "keeper_", (ftnlen)1920)] != 0) 
			{
		    s_copy(source, files + ((i__3 = srces[(i__2 = i__ - 1) < 
			    c__5300 && 0 <= i__2 ? i__2 : s_rnge("srces", i__2, 
			    "keeper_", (ftnlen)1921)] - 1) < c__5300 && 0 <= 
...
/* -& */
    ...
    *found = FALSE_;
    ...
    if (i__ > 0) {
	*found = TRUE_;
	s_copy(filtyp, types + (((i__1 = i__ - 1) < c__5300 && 0 <= i__1 ? i__1 :
		 s_rnge("types", i__1, "keeper_", (ftnlen)2143)) << 3), 
		filtyp_len, (ftnlen)8);
	*handle = handls[(i__1 = i__ - 1) < c__5300 && 0 <= i__1 ? i__1 : s_rnge(
		"handls", i__1, "keeper_", (ftnlen)2144)];
	if (srces[(i__1 = i__ - 1) < c__5300 && 0 <= i__1 ? i__1 : s_rnge("srces"
		, i__1, "keeper_", (ftnlen)2146)] != 0) {
	    s_copy(source, files + ((i__2 = srces[(i__1 = i__ - 1) < c__5300 && 
		    0 <= i__1 ? i__1 : s_rnge("srces", i__1, "keeper_", (
		    ftnlen)2147)] - 1) < c__5300 && 0 <= i__2 ? i__2 : s_rnge(
...
/*     be helpful for debugging. */
    ...
    i__1 = loaded;
    for (i__ = 1; i__ <= i__1; ++i__) {
	s_copy(files + ((i__2 = i__ - 1) < c__5300 && 0 <= i__2 ? i__2 : s_rnge(
		"files", i__2, "keeper_", (ftnlen)2360)) * 255, " ", (ftnlen)
		255, (ftnlen)1);
	handls[(i__2 = i__ - 1) < c__5300 && 0 <= i__2 ? i__2 : s_rnge("handls", 
		i__2, "keeper_", (ftnlen)2361)] = 0;
	srces[(i__2 = i__ - 1) < c__5300 && 0 <= i__2 ? i__2 : s_rnge("srces", 
		i__2, "keeper_", (ftnlen)2362)] = 0;
	s_copy(types + (((i__2 = i__ - 1) < c__5300 && 0 <= i__2 ? i__2 : s_rnge(
...
/*     order. */
    ...
    i__ = loaded;
    while(! gotit && i__ > 0) {
	if (s_cmp(files + ((i__1 = i__ - 1) < c__5300 && 0 <= i__1 ? i__1 : 
...
/*        Stop if we reach two occurrences. */
	...
	while(j <= loaded && nmult < 2) {
	    if (handls[(i__1 = j - 1) < c__5300 && 0 <= i__1 ? i__1 : s_rnge(
		    "handls", i__1, "keeper_", (ftnlen)2780)] == handls[(i__2 
		    = i__ - 1) < c__5300 && 0 <= i__2 ? i__2 : s_rnge("handls", 
...
/*              value. */
    ...
    if (s_cmp(types + (((i__1 = i__ - 1) < c__5300 && 0 <= i__1 ? i__1 : s_rnge(
	    ...
	    (ftnlen)3) == 0) {
	if (single) {
	    spkuef_(&handls[(i__1 = i__ - 1) < c__5300 && 0 <= i__1 ? i__1 : 
		    s_rnge("handls", i__1, "keeper_", (ftnlen)2807)]);
	}
	didspk = TRUE_;
    } else if (s_cmp(types + (((i__1 = i__ - 1) < c__5300 && 0 <= i__1 ? i__1 : 
	    s_rnge("types", i__1, "keeper_", (ftnlen)2812)) << 3), "CK", (
	    ftnlen)8, (ftnlen)2) == 0) {
	if (single) {
	    ckupf_(&handls[(i__1 = i__ - 1) < c__5300 && 0 <= i__1 ? i__1 : 
	...
	didck = TRUE_;
	    ...
	    ftnlen)8, (ftnlen)3) == 0) {
	if (single) {
	    zzdskusf_(&handls[(i__1 = i__ - 1) < c__5300 && 0 <= i__1 ? i__1 : 
	...
	diddsk = TRUE_;
	    ...
	    ftnlen)8, (ftnlen)3) == 0) {
	if (single) {
	    pckuof_(&handls[(i__1 = i__ - 1) < c__5300 && 0 <= i__1 ? i__1 : 
	...
	didpck = TRUE_;
	    ...
	    ftnlen)8, (ftnlen)2) == 0) {
	if (single) {
	    ekuef_(&handls[(i__1 = i__ - 1) < c__5300 && 0 <= i__1 ? i__1 : 
...
/*        that were loaded using this meta-kernel. */
	...
	for (j = loaded; j >= i__1; --j) {
	    if (srces[(i__2 = j - 1) < c__5300 && 0 <= i__2 ? i__2 : s_rnge(
...
/*                 Stop if we reach two occurrences. */
			...
			if (handls[(i__2 = k - 1) < c__5300 && 0 <= i__2 ? i__2 :
				 s_rnge("handls", i__2, "keeper_", (ftnlen)
				2889)] == handls[(i__3 = j - 1) < c__5300 && 0 <=
...
/*                       value. */
		...
		if (s_cmp(types + (((i__2 = j - 1) < c__5300 && 0 <= i__2 ? i__2 
		    ...
		    if (single) {
			spkuef_(&handls[(i__2 = j - 1) < c__5300 && 0 <= i__2 ? 
				i__2 : s_rnge("handls", i__2, "keeper_", (
				ftnlen)2916)]);
		    }
		    didspk = TRUE_;
		} else if (s_cmp(types + (((i__2 = j - 1) < c__5300 && 0 <= i__2 
			? i__2 : s_rnge("types", i__2, "keeper_", (ftnlen)
			2921)) << 3), "CK", (ftnlen)8, (ftnlen)2) == 0) {
		    if (single) {
			ckupf_(&handls[(i__2 = j - 1) < c__5300 && 0 <= i__2 ? 
				i__2 : s_rnge("handls", i__2, "keeper_", (
				ftnlen)2924)]);
		    }
		    didck = TRUE_;
		    ...
		    if (single) {
			zzdskusf_(&handls[(i__2 = j - 1) < c__5300 && 0 <= i__2 ?
				 i__2 : s_rnge("handls", i__2, "keeper_", (
				ftnlen)2932)]);
		    }
		    diddsk = TRUE_;
		    ...
		    if (single) {
			pckuof_(&handls[(i__2 = j - 1) < c__5300 && 0 <= i__2 ? 
				i__2 : s_rnge("handls", i__2, "keeper_", (
				ftnlen)2940)]);
		    }
		    didpck = TRUE_;
		    ...
		    if (single) {
			ekuef_(&handls[(i__2 = j - 1) < c__5300 && 0 <= i__2 ? 
				i__2 : s_rnge("handls", i__2, "keeper_", (
				ftnlen)2948)]);
		    }
		    didek = TRUE_;
...
/*              upwards. */
		...
		i__2 = loaded;
		for (k = j; k <= i__2; ++k) {
		    if (srces[(i__3 = k - 1) < c__5300 && 0 <= i__3 ? i__3 : 
...
/*                    the Jth database entry. */
			...
			srces[(i__3 = k - 1) < c__5300 && 0 <= i__3 ? i__3 : 
				s_rnge("srces", i__3, "keeper_", (ftnlen)2980)
				] = srces[(i__4 = k - 1) < c__5300 && 0 <= i__4 ?
...
/*     database entry. */
    ...
    i__1 = loaded;
    for (j = i__; j <= i__1; ++j) {
	if (srces[(i__2 = j - 1) < c__5300 && 0 <= i__2 ? i__2 : s_rnge("srces", 
		i__2, "keeper_", (ftnlen)3012)] > i__) {

/*           This pointer is affected by the deletion of the Ith */
/*           database entry. */

	    srces[(i__2 = j - 1) < c__5300 && 0 <= i__2 ? i__2 : s_rnge("srces", 
		    i__2, "keeper_", (ftnlen)3017)] = srces[(i__3 = j - 1) < 
		    c__5300 && 0 <= i__3 ? i__3 : s_rnge("srces", i__3, "keeper_"
		    , (ftnlen)3017)] - 1;
	}
    }
...
/*     of the text kernels that were not unloaded. */
	...
	for (i__ = 1; i__ <= i__1; ++i__) {
	    if (s_cmp(types + (((i__2 = i__ - 1) < c__5300 && 0 <= i__2 ? i__2 : 
		    ...
		    i__3 = i__ - 1) < c__5300 && 0 <= i__3 ? i__3 : s_rnge("typ"
		    "es", i__3, "keeper_", (ftnlen)3031)) << 3), "META", (
		    ftnlen)8, (ftnlen)4) == 0) {
		ldpool_(files + ((i__2 = i__ - 1) < c__5300 && 0 <= i__2 ? i__2 :
			 s_rnge("files", i__2, "keeper_", (ftnlen)3034)) * 
			255, (ftnlen)255);
		if (s_cmp(types + (((i__2 = i__ - 1) < c__5300 && 0 <= i__2 ? 
...
/*     to establish the right priority sequence for segments. */
	...
	for (i__ = 1; i__ <= i__1; ++i__) {
		...
		spklef_(files + ((i__2 = i__ - 1) < c__5300 && 0 <= i__2 ? i__2 :
			 s_rnge("files", i__2, "keeper_", (ftnlen)3063)) * 
			255, &handls[(i__3 = i__ - 1) < c__5300 && 0 <= i__3 ? 
...
/*     for the remaining C-kernels. */
	...
	for (i__ = 1; i__ <= i__1; ++i__) {
	    if (s_cmp(types + (((i__2 = i__ - 1) < c__5300 && 0 <= i__2 ? i__2 : 
		    ...
		    "CK", (ftnlen)8, (ftnlen)2) == 0) {
		cklpf_(files + ((i__2 = i__ - 1) < c__5300 && 0 <= i__2 ? i__2 : 
			s_rnge("files", i__2, "keeper_", (ftnlen)3077)) * 255,
			 &handls[(i__3 = i__ - 1) < c__5300 && 0 <= i__3 ? i__3 :
...
/*     remaining DSKs. */
	...
	for (i__ = 1; i__ <= i__1; ++i__) {
	    if (s_cmp(types + (((i__2 = i__ - 1) < c__5300 && 0 <= i__2 ? i__2 : 
		    ...
		    "DSK", (ftnlen)8, (ftnlen)3) == 0) {
		zzdsklsf_(files + ((i__2 = i__ - 1) < c__5300 && 0 <= i__2 ? 
...
/*     kernels. */
	...
	for (i__ = 1; i__ <= i__1; ++i__) {
	    if (s_cmp(types + (((i__2 = i__ - 1) < c__5300 && 0 <= i__2 ? i__2 : 
		    ...
		    "PCK", (ftnlen)8, (ftnlen)3) == 0) {
		pcklof_(files + ((i__2 = i__ - 1) < c__5300 && 0 <= i__2 ? i__2 :
...
/*     of loaded kernels. */
	...
	for (i__ = 1; i__ <= i__1; ++i__) {
	    if (s_cmp(types + (((i__2 = i__ - 1) < c__5300 && 0 <= i__2 ? i__2 : 
		    ...
		    "EK", (ftnlen)8, (ftnlen)2) == 0) {
		eklef_(files + ((i__2 = i__ - 1) < c__5300 && 0 <= i__2 ? i__2 : 
