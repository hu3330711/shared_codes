...
loadcdf,cdffile,'Epoch',t
epoch0 = 719528.d * 24.* 3600. * 1000.  ;Jan 1, 1970
t = (t- epoch0)/1000.
;return,minmax_range(t)
n = n_elements(t)
return,t([0,n-1])
end
...
;VERSION:
;  96/10/15  make_cdf_index.pro  1.2
;  02/06/06  Ran into file limitation on findfile, now spawn find
;  	     instead 
;-
...
for n=0,n_elements(data_direc)-1 do begin
  spawn, ['find',  data_direc(n),  '-type',  'f', '-name', pattern], $
    f, /NOSHELL
