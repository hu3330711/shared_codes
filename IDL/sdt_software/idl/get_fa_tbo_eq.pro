...
FUNCTION Get_fa_tbo_eq, inputTime, START=start, EN=en, ADVANCE=advance,  $
      ...
      REPEAT BEGIN
          IF NOT first THEN       $
            print, 'get_fa_tbo_eq.pro: Badly formed data.  Getting next sample'
          first = 0
...
ENDWHILE
      ...
      data(*,0) = data0(*,3,0) + data0(*,4,0)
      data(*,1) = data0(*,11,0) + data0(*,12,0)
      ...
      ELSE PRINT,"Data reading/timing problem detected by get_fa_tbo_eq!"
      ...
      mass = 0.1670224                         ; mass AMU/CHARGE
