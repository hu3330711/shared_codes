FUNCTION FA_TS_EFF_EQ, en, pac, spec, mode, spin_section, eff_version, time
;+
; FUNCTION:
;        FA_TS_EFF_EQ
;
...
;
; 	argument TIME added, summer of 2003, by Y. Cao
;-	      
; 	  
; 
; 
; FUNCTION FA_TS_EFF_EQ, en, pac, spec, mode, spin_section, version. timestring

 ang2pix =[[3, 3, 3, 3, 3, 3, 3, 3, 11, 11, 11, 11, 11, 11, 11, 11],     $
          [11, 11, 11, 11, 11, 11, 11, 11, 3, 3, 3, 3, 3, 3, 3, 3]]

           nbins = dimen2(en)
           ebins = dimen1(en)       ; print, nbins, ebins
