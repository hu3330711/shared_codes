...
;	@(#)fa_nadir_sun_azim.pro	1.2 04/20/05
...
FUNCTION fa_nadir_sun_azim, nadir, orb
   ...
   flg64 = 1
   lmdln1 = STRING ('sunNadirIdlUtilLib_3264.so')
   if (!VERSION.RELEASE LE '5.4') then begin
       flg64 = 0
       lmdln1 = STRING ('sunNadirIdlUtilLib.so')
   endif

   ret = call_external (lmdln1, 'calcSunNadirAzim',		$
                        attX,					$
                        attY,					$
                        attZ,					$
                        orbitX,					$
