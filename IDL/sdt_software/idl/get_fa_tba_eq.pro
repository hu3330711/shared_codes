...
FUNCTION Get_fa_tba_eq, inputTime, START=start, EN=en, ADVANCE=advance,  $
      ...
      REPEAT BEGIN
          IF NOT first THEN       $
            print, 'get_fa_tba_eq.pro: Badly formed data.  Getting next sample'
          first = 0
...
ENDWHILE
      ...
      data(*,0) = data0(*,3,3) + data0(*,4,3)
      data(*,1) = data0(*,11,3) + data0(*,12,3)
      ...
      ELSE PRINT,"Data reading/timing problem detected by get_fa_tba_eq!"
      ...
      mass = 0.0208778                        ; mass AMU/CHARGE
