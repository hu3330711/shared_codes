...
if n_elements(dydat) ne 0 then  add_str_element,plot,'dy',dydat
...
mplot,data=plot,COLORS=shades,limits = limits,$
   LABELS=labels,OPLOT=oplot,nocolor=nocolor
